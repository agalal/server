...
class ActivityTest extends TestCase {
	...
	public function dataTestGetDefaultType() {
		return array(
			...
			array('stream', array(\OCA\Files_Sharing\Activity::TYPE_SHARED, \OCA\Files_Sharing\Activity::TYPE_REMOTE_SHARE, \OCA\Files_Sharing\Activity::TYPE_PUBLIC_LINKS, \OCA\Files_Sharing\Activity::TYPE_EMAIL_SHARE)),
		);
	}
